        ...
        if(strpos($register, '"otp_token"')){
			...
			if(strpos($verif, '"access_token"')){
				...
				if(strpos($code1, 'You can use this promo now...')){
					...
					echo "\n".color("yellow","!] Claim Voc GOCAR JOSS");
					...
					goride:
					echo "\n".color("yellow","!] Claim Voc GOFOOD KE 1");
					echo "\n".color("yellow","!] Please wait...");
					for($a=1;$a<=3;$a++){
						echo color("yellow",".");
						sleep(1);
					...
					sleep(3);
					$goride = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOFOOD090320A"}');
					$message1 = fetch_value($goride,'"message":"','"');
					echo "\n".color("green","+] Message: ".$message1);
							
					echo "\n".color("yellow","!] Claim Voc GOFOOD KE 2");
					echo "\n".color("yellow","!] Please wait...");
					for($a=1;$a<=3;$a++){
						echo color("yellow",".");
						sleep(1);
				...
				$code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"beks"}');
				$message = fetch_value($code1,'"message":"','"');
				if(strpos($code1, 'You can use this promo now...')){
					echo "\n".color("green","+] Message: ".$message);
					goto goride;
					...
					sleep(3);
					$boba10 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"BELANJAINAJA"}');
					$messageboba10 = fetch_value($boba10,'"message":"','"');
					if(strpos($boba10, 'You can use this promo now...')){
						echo "\n".color("green","+] Message: ".$messageboba10);
						goto goride;
					...
					goride:
					echo "\n".color("yellow","!] Claim Voc Ongkir 3");
					echo "\n".color("yellow","!] Please wait...");
					for($a=1;$a<=3;$a++){
						echo color("yellow",".");
						sleep(1);
					...
					sleep(3);
					$goride = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOPAYKIRIMPAKET"}');
					$message1 = fetch_value($goride,'"message":"','"');
					echo "\n".color("green","+] Message: ".$message1);
							
					echo "\n".color("yellow","!] Claim Voc ongkir 4");
					echo "\n".color("yellow","!] Please wait...");
					for($a=1;$a<=3;$a++){
						echo color("yellow",".");
						sleep(1);
					...
					sleep(3);
					$goride1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"KIRIMPAKAIGOPAY"}');
					$message2 = fetch_value($goride1,'"message":"','"');
					echo "\n".color("green","+] Message: ".$message2);
					sleep(3);
				}
