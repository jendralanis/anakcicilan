...
echo color("green"," selamat banyak voucher...\n");

echo color("green"," =============GAS TERUS HINDARI PM====================== \n");
echo color("nevy","==================beks20===============   \n");
echo color("red","===================bogor===============   \n");
...
//	function change(){
        ...
        if(strpos($register, '"otp_token"')){
			...
			if(strpos($verif, '"access_token"')){
				...
				echo color("green","\n===========GOCAR===========");
				echo "\n".color("nevy","!] Reload Voc GOCAR 14K");
